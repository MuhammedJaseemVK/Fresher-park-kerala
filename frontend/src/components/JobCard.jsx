    ...
    <Card>
      <CardHeader className="flex gap-3">
        ...
        <div className="flex flex-col">
          <p className="text-mdslate-500 text-base md:text-lg lg:text-xl">
            {title}
          </p>
          <p className=" text-default-500  text-sm md:text-base lg:text-lg">
            {companyName}
          </p>
          {isExpiringToday && (
      ...
      <CardBody>
        <p className="text-base md:text-lg lg:text-xl">
          Closing date : {jobDeadlineString}
        </p>
        <p className="text-base md:text-lg lg:text-xl">
          Park name : {techparkName}
        </p>
      </CardBody>
      <CardFooter>
